---
title: Low-level API
id: version-2.1.0-M6-53-gb4f448130-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M6-53-gb4f448130",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M6-53-gb4f448130"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M6-53-gb4f448130"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M6-53-gb4f448130"`, is precisely in charge of fetching
