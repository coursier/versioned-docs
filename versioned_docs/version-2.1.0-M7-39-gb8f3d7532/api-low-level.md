---
title: Low-level API
id: version-2.1.0-M7-39-gb8f3d7532-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M7-39-gb8f3d7532",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M7-39-gb8f3d7532"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M7-39-gb8f3d7532"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M7-39-gb8f3d7532"`, is precisely in charge of fetching
