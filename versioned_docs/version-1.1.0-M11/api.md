...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "1.1.0-M11",
  "io.get-coursier" %% "coursier-cache" % "1.1.0-M11"
)
```
...
The first module, `"io.get-coursier" %% "coursier" % "1.1.0-M11"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.1.0-M11"`, is precisely in charge of fetching
