---
title: Low-level API
id: version-2.0.4-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.0.4",
  "io.get-coursier" %% "coursier-cache" % "2.0.4"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.0.4"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.4"`, is precisely in charge of fetching
