...
title: Overview
hide_title: true
id: version-2.0.0-RC6-4-cli-overview
...
|-|-|-|
|Linux|<https://github.com/coursier/coursier/releases/download/v2.0.0-RC6-4/cs-x86_64-pc-linux>|`2.0.0-RC3-1`|
|macOS|<https://github.com/coursier/coursier/releases/download/v2.0.0-RC6-4/cs-x86_64-apple-darwin>|`2.0.0-RC3-1`|
|Windows|<https://github.com/coursier/coursier/releases/download/v2.0.0-RC6-4/cs-x86_64-pc-win32.exe>|`2.0.0-RC6`|
|Any (needs JVM)|<https://github.com/coursier/coursier/releases/download/v2.0.0-RC6-4/coursier>|`1.1.0-M9`|
