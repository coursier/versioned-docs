---
title: Low-level API
id: version-2.1.0-M6-49-gff26f8e39-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M6-49-gff26f8e39"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M6-49-gff26f8e39"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M6-49-gff26f8e39"`, is precisely in charge of fetching
