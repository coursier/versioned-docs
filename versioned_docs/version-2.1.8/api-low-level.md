---
title: Low-level API
id: version-2.1.8-api-low-level
...
The first module, `"io.get-coursier" %% "coursier-core" % "2.1.8"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.8"`, is precisely in charge of fetching
