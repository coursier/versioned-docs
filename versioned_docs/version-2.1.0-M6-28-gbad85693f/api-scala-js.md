---
title: Scala.js
id: version-2.1.0-M6-28-gbad85693f-api-scala-js
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %%% "coursier-fetch-js" % "2.1.0-M6-28-gbad85693f"
)
```
or simply via the `coursier` module, which aggregates both,
```scala
libraryDependencies += "io.get-coursier" %%% "coursier" % "2.1.0-M6-28-gbad85693f"
```
