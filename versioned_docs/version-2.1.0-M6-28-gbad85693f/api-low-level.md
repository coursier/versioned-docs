---
title: Low-level API
id: version-2.1.0-M6-28-gbad85693f-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M6-28-gbad85693f",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M6-28-gbad85693f"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M6-28-gbad85693f"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M6-28-gbad85693f"`, is precisely in charge of fetching
