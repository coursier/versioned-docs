---
title: Low-level API
id: version-2.0.0-RC3-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.0.0-RC3",
  "io.get-coursier" %% "coursier-cache" % "2.0.0-RC3"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.0.0-RC3"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.0-RC3"`, is precisely in charge of fetching
