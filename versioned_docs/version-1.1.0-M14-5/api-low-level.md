---
title: Low-level API
id: version-1.1.0-M14-5-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "1.1.0-M14-5",
  "io.get-coursier" %% "coursier-cache" % "1.1.0-M14-5"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "1.1.0-M14-5"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.1.0-M14-5"`, is precisely in charge of fetching
