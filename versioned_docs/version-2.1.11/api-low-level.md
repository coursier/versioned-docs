---
title: Low-level API
id: version-2.1.11-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.1.11"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.11"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.11"`, is precisely in charge of fetching
