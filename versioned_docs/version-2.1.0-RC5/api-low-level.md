---
title: Low-level API
id: version-2.1.0-RC5-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-RC5",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-RC5"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-RC5"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-RC5"`, is precisely in charge of fetching
