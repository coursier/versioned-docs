---
title: Low-level API
id: version-2.0.0-RC6-10-api-low-level
...
The first module, `"io.get-coursier" %% "coursier-core" % "2.0.0-RC6-10"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-10"`, is precisely in charge of fetching
