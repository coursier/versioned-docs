---
title: Scala.js
id: version-2.1.0-M7-34-gf519b50a3-api-scala-js
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %%% "coursier-fetch-js" % "2.1.0-M7-34-gf519b50a3"
)
```
or simply via the `coursier` module, which aggregates both,
```scala
libraryDependencies += "io.get-coursier" %%% "coursier" % "2.1.0-M7-34-gf519b50a3"
```
