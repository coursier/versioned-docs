---
title: Low-level API
id: version-2.1.24-api-low-level
...
The first module, `"io.get-coursier" %% "coursier-core" % "2.1.24"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.24"`, is precisely in charge of fetching
