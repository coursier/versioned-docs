---
title: Low-level API
id: version-2.1.19-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.1.19"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.19"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.19"`, is precisely in charge of fetching
