---
title: Low-level API
id: version-2.0.0-RC6-5-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.0.0-RC6-5",
  "io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-5"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.0.0-RC6-5"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-5"`, is precisely in charge of fetching
