---
title: Low-level API
id: version-1.1.0-M12-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "1.1.0-M12",
  "io.get-coursier" %% "coursier-cache" % "1.1.0-M12"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "1.1.0-M12"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.1.0-M12"`, is precisely in charge of fetching
