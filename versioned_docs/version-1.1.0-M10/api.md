...
The first module, `"io.get-coursier" %% "coursier" % "1.1.0-M10"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.1.0-M10"`, is precisely in charge of fetching
