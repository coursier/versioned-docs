---
title: Low-level API
id: version-2.1.0-M5-1-gc8a0a64bd-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M5-1-gc8a0a64bd",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M5-1-gc8a0a64bd"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M5-1-gc8a0a64bd"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M5-1-gc8a0a64bd"`, is precisely in charge of fetching
