---
title: Scala.js
id: version-2.1.0-M5-1-gc8a0a64bd-api-scala-js
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %%% "coursier-fetch-js" % "2.1.0-M5-1-gc8a0a64bd"
)
```
or simply via the `coursier` module, which aggregates both,
```scala
libraryDependencies += "io.get-coursier" %%% "coursier" % "2.1.0-M5-1-gc8a0a64bd"
```
