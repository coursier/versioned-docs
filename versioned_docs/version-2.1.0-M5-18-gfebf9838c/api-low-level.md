---
title: Low-level API
id: version-2.1.0-M5-18-gfebf9838c-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M5-18-gfebf9838c",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M5-18-gfebf9838c"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M5-18-gfebf9838c"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M5-18-gfebf9838c"`, is precisely in charge of fetching
