---
title: Low-level API
id: version-2.1.0-M5-5-g2cb552ea9-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M5-5-g2cb552ea9"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M5-5-g2cb552ea9"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M5-5-g2cb552ea9"`, is precisely in charge of fetching
