---
title: Low-level API
id: version-2.1.25-M1-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.25-M1",
  "io.get-coursier" %% "coursier-cache" % "2.1.25-M1"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.25-M1"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.25-M1"`, is precisely in charge of fetching
