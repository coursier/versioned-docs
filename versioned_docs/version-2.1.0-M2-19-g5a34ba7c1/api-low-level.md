---
title: Low-level API
id: version-2.1.0-M2-19-g5a34ba7c1-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M2-19-g5a34ba7c1"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M2-19-g5a34ba7c1"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M2-19-g5a34ba7c1"`, is precisely in charge of fetching
