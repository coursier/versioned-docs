---
title: Installation
id: version-2.1.25-M23-cli-installation
...
| --------------- | --------------------------------------------------------------------------------------------- | ----------------------- |
| Linux           | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-pc-linux.gz>     | `2.0.16-158-gbdc8669f9` |
| macOS           | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-apple-darwin.gz> | `2.0.16-158-gbdc8669f9` |
| Windows         | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-pc-win32.exe>    | `2.0.16-158-gbdc8669f9` |
| Linux (ARM64)   | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-aarch64-pc-linux.gz>    | `2.0.16-158-gbdc8669f9` |
| Any (needs JVM) | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/coursier>                  | `1.1.0-M9`              |

Former URLs, for information:

| OS              | URL                                                                                        | Since version | Up to version |
| --------------- | ------------------------------------------------------------------------------------------ | ------------- | ------------- |
| Linux           | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-pc-linux>     | `2.0.0-RC3-1` | `2.0.16`      |
| macOS           | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-apple-darwin> | `2.0.0-RC3-1` | `2.0.16`      |
| Windows         | <https://github.com/coursier/coursier/releases/download/v2.1.25-M23/cs-x86_64-pc-win32.exe> | `2.0.0-RC6`   | `2.0.16`      |
