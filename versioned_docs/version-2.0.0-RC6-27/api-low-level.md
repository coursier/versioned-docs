---
title: Low-level API
id: version-2.0.0-RC6-27-api-low-level
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-27+11-59bf7739-SNAPSHOT"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.0.0-RC6-27+11-59bf7739-SNAPSHOT"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-27+11-59bf7739-SNAPSHOT"`, is precisely in charge of fetching
