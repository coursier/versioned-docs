---
title: Low-level API
id: version-2.1.0-M6-26-gcec901e9a-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M6-26-gcec901e9a",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M6-26-gcec901e9a"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M6-26-gcec901e9a"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M6-26-gcec901e9a"`, is precisely in charge of fetching
