---
title: Scala.js
id: version-2.1.0-M6-26-gcec901e9a-api-scala-js
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %%% "coursier-fetch-js" % "2.1.0-M6-26-gcec901e9a"
)
```
or simply via the `coursier` module, which aggregates both,
```scala
libraryDependencies += "io.get-coursier" %%% "coursier" % "2.1.0-M6-26-gcec901e9a"
```
