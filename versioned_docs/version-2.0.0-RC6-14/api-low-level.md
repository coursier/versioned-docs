---
title: Low-level API
id: version-2.0.0-RC6-14-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.0.0-RC6-14",
  "io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-14"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.0.0-RC6-14"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.0.0-RC6-14"`, is precisely in charge of fetching
