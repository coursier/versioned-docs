---
title: Low-level API
id: version-2.1.25-M7-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.25-M7",
  "io.get-coursier" %% "coursier-cache" % "2.1.25-M7"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.25-M7"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.25-M7"`, is precisely in charge of fetching
