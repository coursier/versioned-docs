---
title: Scala.js
id: version-2.1.0-M2-21-g68e654e07-api-scala-js
...
libraryDependencies ++= Seq(
  ...
  "io.get-coursier" %%% "coursier-fetch-js" % "2.1.0-M2-21-g68e654e07"
)
```
or simply via the `coursier` module, which aggregates both,
```scala
libraryDependencies += "io.get-coursier" %%% "coursier" % "2.1.0-M2-21-g68e654e07"
```
