---
title: Low-level API
id: version-2.1.0-M2-21-g68e654e07-api-low-level
...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-core" % "2.1.0-M2-21-g68e654e07",
  "io.get-coursier" %% "coursier-cache" % "2.1.0-M2-21-g68e654e07"
)
```

The first module, `"io.get-coursier" %% "coursier-core" % "2.1.0-M2-21-g68e654e07"`, contains among others,
definitions,
...
The second module, `"io.get-coursier" %% "coursier-cache" % "2.1.0-M2-21-g68e654e07"`, is precisely in charge of fetching
